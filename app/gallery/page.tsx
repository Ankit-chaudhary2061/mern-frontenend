...
const SliderGallery = () => {
  ...
  return (
    <section className='relative w-full bg-white'>
      <div className='container mx-auto px-4 py-[40px]' data-aos='zoom-in-up'>
        <div className='pb-16'>
          <div className='mb-10 text-center' data-aos='fade-up'>
            <p className='text-sm uppercase tracking-[0.35em] text-[#326E3B] font-semibold mb-3'>Tea Gallery</p>
